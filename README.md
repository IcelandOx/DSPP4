...
For educational games they indicate a trade-off between user ratings and academic value. 
While a correlation between complexity and ratings may be observed in the Apprentice’s experiment, these should not be considered as the only factors for commercial success. Lower-rated games may still have commercial value and may make new markets available, e.g. educational products for schools.
